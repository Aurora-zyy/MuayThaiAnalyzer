...
export default function UploadPage() {
  ...
  const [professionalVideoPreview, setProfessionalVideoPreview] = useState<
    string | null
  >(null);
  ...
  const handleProfessionalVideoChange = (
  ...
  const simulateQuickAnalysis = async () => {
    if (!userVideo) return;
    ...
    try {
      ...
      // Call our API route which connects to backend
      ...
      // Store real analysis results in sessionStorage
        ...
        <div className="flex items-center justify-between">
          <div
            className={`flex items-center ${
              currentStep === "user-video" ? "text-red-600" : "text-green-600"
            }`}
          >
              ...
              <Tabs defaultValue="upload" className="w-full">
                  ...
                  <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                    {userVideoPreview ? (
                      ...
                      <>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                          Or click to browse (MP4, MOV, up to 60 seconds)
                        </p>
                      </>
                    )}
                    ...
                    <div className="mt-4">
                      ...
                      <label htmlFor="user-video-upload">
                        <Button
                          variant={userVideoPreview ? "outline" : "default"}
                ...
                <TabsContent value="record">
                  <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                    ...
                    <p className="text-sm text-gray-500 mb-4">
                      Use your device camera to record up to 60 seconds
                    </p>
            ...
            <CardContent>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <p className="text-sm text-blue-700">
                  Upload a video of a professional Muay Thai fighter performing
                  the same technique. This will be used as the reference
                  standard for comparison analysis.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center border-2 border-dashed border-blue-300 rounded-lg p-12 text-center">
                {professionalVideoPreview ? (
                  <div className="w-full">
                    <video
                      src={professionalVideoPreview}
                      controls
                      className="w-full max-h-[400px] rounded-lg mb-4"
                    />
                    <p className="text-sm text-gray-500 mb-4">
                      {professionalVideo?.name} (
                      {Math.round(
                        ((professionalVideo?.size || 0) / 1024 / 1024) * 10
                      ) / 10}{" "}
                      MB)
                    </p>
                    <div className="flex items-center justify-center text-green-600 mb-4">
              ...
              <div className="mt-6 flex justify-between">
                <Button
                  variant="outline"
                  onClick={() => setCurrentStep("user-video")}
                >
                  Back to Your Video
                </Button>
                {professionalVideo && (
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-6 flex justify-center">
                <Button
                  variant="ghost"
                  onClick={() => setCurrentStep("professional-video")}
                >
                  Back to Edit Videos
                </Button>
              </div>
